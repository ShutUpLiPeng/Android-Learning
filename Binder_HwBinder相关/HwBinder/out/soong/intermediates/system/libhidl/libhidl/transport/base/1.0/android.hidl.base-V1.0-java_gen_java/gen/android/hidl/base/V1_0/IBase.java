...
public interface IBase extends android.os.IHwInterface {
    public static final String kInterfaceName = "android.hidl.base@1.0::IBase";

    /* package private */ static IBase asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    public static IBase castFrom(android.os.IHwInterface iface) {
        return (iface == null) ? null : IBase.asInterface(iface.asBinder());
    }

    @Override
    public android.os.IHwBinder asBinder();

    public static IBase getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IBase.asInterface(android.os.HwBinder.getService("android.hidl.base@1.0::IBase", serviceName, retry));
    }

    public static IBase getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    public static IBase getService(String serviceName) throws android.os.RemoteException {
        return IBase.asInterface(android.os.HwBinder.getService("android.hidl.base@1.0::IBase", serviceName));
    }

    public static IBase getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements IBase {
        ...
        public String toString() {
            ...
            return "[class or subclass of " + IBase.kInterfaceName + "]@Proxy";
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBase {
        ...
        public final String interfaceDescriptor() {
            return android.hidl.base.V1_0.IBase.kInterfaceName;
