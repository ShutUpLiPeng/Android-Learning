...
::android::status_t BnHwServiceManager::_hidl_list(
    ...
    static_cast<IServiceManager*>(_hidl_this->getImpl().get())->list([&](const auto &_hidl_out_fqInstanceNames) {
...
::android::status_t BnHwServiceManager::_hidl_listByInterface(
    ...
    static_cast<IServiceManager*>(_hidl_this->getImpl().get())->listByInterface(*fqName, [&](const auto &_hidl_out_instanceNames) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwServiceManager::_hidl_debugDump(
    ...
    static_cast<IServiceManager*>(_hidl_this->getImpl().get())->debugDump([&](const auto &_hidl_out_info) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwServiceManager::_hidl_registerPassthroughClient(
    ...
    static_cast<IServiceManager*>(_hidl_this->getImpl().get())->registerPassthroughClient(*fqName, *name);
